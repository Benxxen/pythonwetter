...
cursor.execute("INSERT INTO PythonWetter_weather (Datum, Stadt, Anbieter, Wetter, Tagestemperatur, Einheit, Kondition, Windgeschwindigkeit, Windrichtung) VALUES ('2014-10-21','Potsdam','Yahoo',%s,10,'C',30,60,'SW')", str(ycondition.getAttribute('text')),)
connection.commit()
connection.close()